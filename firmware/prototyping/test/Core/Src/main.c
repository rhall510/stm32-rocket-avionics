...
static void MX_SPI1_Init(void)
{
  ...
  hspi1_acc.Init.Direction = SPI_DIRECTION_2LINES;
  hspi1_acc.Init.DataSize = SPI_DATASIZE_8BIT;
  hspi1_acc.Init.CLKPolarity = SPI_POLARITY_LOW;
  hspi1_acc.Init.CLKPhase = SPI_PHASE_1EDGE;
  hspi1_acc.Init.NSS = SPI_NSS_SOFT;
  ...
  hspi1_acc.Init.CRCCalculation = SPI_CRCCALCULATION_DISABLE;
  hspi1_acc.Init.CRCPolynomial = 7;
  hspi1_acc.Init.CRCLength = SPI_CRC_LENGTH_DATASIZE;
  hspi1_acc.Init.NSSPMode = SPI_NSS_PULSE_ENABLE;
  if (HAL_SPI_Init(&hspi1_acc) != HAL_OK)
  {
    Error_Handler();
  }
...
static void MX_SPI2_Init(void)
{
  ...
  if (HAL_SPI_Init(&hspi2_str) != HAL_OK)
  {
    Error_Handler();
  }
